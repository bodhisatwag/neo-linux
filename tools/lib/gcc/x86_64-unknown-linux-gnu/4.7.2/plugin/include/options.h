...
enum opt_code
{
  ...
  OPT_m128bit_long_double = 983,             /* -m128bit-long-double */
  OPT_m32 = 984,                             /* -m32 */
  OPT_m3dnow = 985,                          /* -m3dnow */
  OPT_m3dnowa = 986,                         /* -m3dnowa */
  OPT_m64 = 987,                             /* -m64 */
  OPT_m80387 = 988,                          /* -m80387 */
  OPT_m8bit_idiv = 989,                      /* -m8bit-idiv */
  OPT_m96bit_long_double = 990,              /* -m96bit-long-double */
  OPT_mabi_ = 991,                           /* -mabi= */
  OPT_mabm = 992,                            /* -mabm */
  OPT_maccumulate_outgoing_args = 993,       /* -maccumulate-outgoing-args */
  OPT_maes = 994,                            /* -maes */
  OPT_malign_double = 995,                   /* -malign-double */
  OPT_malign_functions_ = 996,               /* -malign-functions= */
  OPT_malign_jumps_ = 997,                   /* -malign-jumps= */
  OPT_malign_loops_ = 998,                   /* -malign-loops= */
  OPT_malign_stringops = 999,                /* -malign-stringops */
  OPT_mandroid = 1000,                       /* -mandroid */
  OPT_march_ = 1001,                         /* -march= */
  OPT_masm_ = 1002,                          /* -masm= */
  OPT_mavx = 1003,                           /* -mavx */
  OPT_mavx2 = 1004,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1005,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1006,  /* -mavx256-split-unaligned-store */
  OPT_mbionic = 1007,                        /* -mbionic */
  OPT_mbmi = 1008,                           /* -mbmi */
  OPT_mbmi2 = 1009,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1010,                  /* -mbranch-cost= */
  OPT_mcld = 1011,                           /* -mcld */
  OPT_mcmodel_ = 1012,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1013, */                    /* -mcpu= */
  OPT_mcrc32 = 1014,                         /* -mcrc32 */
  OPT_mcx16 = 1015,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1016,            /* -mdispatch-scheduler */
  OPT_mf16c = 1017,                          /* -mf16c */
  OPT_mfancy_math_387 = 1018,                /* -mfancy-math-387 */
  OPT_mfentry = 1019,                        /* -mfentry */
  OPT_mfma = 1020,                           /* -mfma */
  OPT_mfma4 = 1021,                          /* -mfma4 */
  OPT_mforce_drap = 1022,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1023,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1024,                       /* -mfpmath= */
  OPT_mfsgsbase = 1025,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1026, */              /* -mfused-madd */
  OPT_mglibc = 1027,                         /* -mglibc */
  OPT_mhard_float = 1028,                    /* -mhard-float */
  OPT_mieee_fp = 1029,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1030,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1031,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1032,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1033, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1034,         /* -mlarge-data-threshold= */
  OPT_mlwp = 1035,                           /* -mlwp */
  OPT_mlzcnt = 1036,                         /* -mlzcnt */
  OPT_mmmx = 1037,                           /* -mmmx */
  OPT_mmovbe = 1038,                         /* -mmovbe */
  OPT_mms_bitfields = 1039,                  /* -mms-bitfields */
  OPT_mno_align_stringops = 1040,            /* -mno-align-stringops */
  OPT_mno_fancy_math_387 = 1041,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1042,                  /* -mno-push-args */
  OPT_mno_red_zone = 1043,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1044,                       /* -mno-sse4 */
  OPT_momit_leaf_frame_pointer = 1045,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1046,                          /* -mpc32 */
  OPT_mpc64 = 1047,                          /* -mpc64 */
  OPT_mpc80 = 1048,                          /* -mpc80 */
  OPT_mpclmul = 1049,                        /* -mpclmul */
  OPT_mpopcnt = 1050,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1051,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1052,     /* -mpreferred-stack-boundary= */
  OPT_mpush_args = 1053,                     /* -mpush-args */
  OPT_mrdrnd = 1054,                         /* -mrdrnd */
  OPT_mrecip = 1055,                         /* -mrecip */
  OPT_mrecip_ = 1056,                        /* -mrecip= */
  OPT_mred_zone = 1057,                      /* -mred-zone */
  OPT_mregparm_ = 1058,                      /* -mregparm= */
  OPT_mrtd = 1059,                           /* -mrtd */
  OPT_msahf = 1060,                          /* -msahf */
  OPT_msoft_float = 1061,                    /* -msoft-float */
  OPT_msse = 1062,                           /* -msse */
  OPT_msse2 = 1063,                          /* -msse2 */
  OPT_msse2avx = 1064,                       /* -msse2avx */
  OPT_msse3 = 1065,                          /* -msse3 */
  OPT_msse4 = 1066,                          /* -msse4 */
  OPT_msse4_1 = 1067,                        /* -msse4.1 */
  OPT_msse4_2 = 1068,                        /* -msse4.2 */
  OPT_msse4a = 1069,                         /* -msse4a */
  /* OPT_msse5 = 1070, */                    /* -msse5 */
  OPT_msseregparm = 1071,                    /* -msseregparm */
  OPT_mssse3 = 1072,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1073,               /* -mstack-arg-probe */
  OPT_mstackrealign = 1074,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1075,            /* -mstringop-strategy= */
  OPT_mtbm = 1076,                           /* -mtbm */
  OPT_mtls_dialect_ = 1077,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1078,           /* -mtls-direct-seg-refs */
  OPT_mtune_ = 1079,                         /* -mtune= */
  OPT_muclibc = 1080,                        /* -muclibc */
  OPT_mveclibabi_ = 1081,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1082,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1083,                    /* -mvzeroupper */
  OPT_mx32 = 1084,                           /* -mx32 */
  OPT_mxop = 1085,                           /* -mxop */
  OPT_n = 1086,                              /* -n */
  ...
  OPT_std_c__98 = 1137,                      /* -std=c++98 */
  OPT_std_c11 = 1138,                        /* -std=c11 */
  /* OPT_std_c1x = 1139, */                  /* -std=c1x */
  /* OPT_std_c89 = 1140, */                  /* -std=c89 */
  OPT_std_c90 = 1141,                        /* -std=c90 */
  OPT_std_c99 = 1142,                        /* -std=c99 */
  /* OPT_std_c9x = 1143, */                  /* -std=c9x */
  OPT_std_f2003 = 1144,                      /* -std=f2003 */
  OPT_std_f2008 = 1145,                      /* -std=f2008 */
  OPT_std_f2008ts = 1146,                    /* -std=f2008ts */
  OPT_std_f95 = 1147,                        /* -std=f95 */
  OPT_std_gnu = 1148,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1149, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1150, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1151,                    /* -std=gnu++11 */
